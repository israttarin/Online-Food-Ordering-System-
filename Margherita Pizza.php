...
<html>
	...
	<body>
		<div class="head">
			...
			<div class="pics">
			    <ul>
					<ul><img src="Italian/Margherita Pizza.jpg" height="900" width="900"></ul>
					<ul>
						<select>
							<option>Large : 12" 1200/= </option>
							<option>Medium : 10" 800/= </option>
							<option>Large : 8" 400/= </option>
						</select>
					</ul>
						
					<ul><label>Margherita Pizza </label></ul>
