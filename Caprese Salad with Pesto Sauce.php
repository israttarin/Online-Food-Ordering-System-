...
<html>
	...
	<body>
		<div class="head">
			...
			<div class="pics">
			    <ul>
					<ul><img src="Italian/Caprese Salad with Pesto Sauce.jpg" height="900" width="900"></ul>
					<ul><label> Price : 150/= </label></ul>
					<ul><label>Caprese Salad with Pesto Sauce</label></ul>
