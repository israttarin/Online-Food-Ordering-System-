...
<html>
	...
	<body>
		<div class="head">
			...
			<div class="pics">
			    <ul>
					<ul><img src="Dessert/kheer goja.jpg" height="900" width="900"></ul>
					<ul>
						<select>
							<option>1 kg : 320/= </option>
							<option>1/2 kg : 150/= </option>
							<option>1 peace : 15/= </option>
						</select>
					</ul>
					<ul><label>kheer goja </label></ul>
