...
<html>
	...
	<body>
		<div class="head">
			...
			<div class="pics">
			    <ul>
					<ul><img src="Dessert/gulab jamun.jpg" height="900" width="900"></ul>
					<ul>
						<select>
							<option>1 kg : 350/= </option>
							<option>1/2 kg : 175/= </option>
							<option>1 peace : 20/= </option>
						</select>
					</ul>
					<ul><label>gulab jamun</label></ul>
