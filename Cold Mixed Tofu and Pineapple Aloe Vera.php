...
<html>
	...
	<body>
		<div class="head">
			...
			<div class="pics">
			    <ul>
					<ul><img src="Chinese/Cold Mixed Tofu and Pineapple Aloe Vera.jpg" height="900" width="900"></ul>
					<ul><label> Price : 155/= </label></ul>
					<ul><label>Cold Mixed Tofu and Pineapple Aloe Vera </label></ul>
